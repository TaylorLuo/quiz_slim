...
create network db
execute script: python export_inference_graph_single.py --model_name=cifarnet --batch_size=1 --dataset_name=cifar10 --output_file=cifarnet_graph_def.pb --dataset_dir=/f/002---study/00AA_AI/CSDN/tmp/cifar10/
